...
public class RfbEvent implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<RfbEventAttendance> eventAttendances = new HashSet<>();
    ...
    public Set<RfbEventAttendance> getEventAttendances() {
        return eventAttendances;
    }

    public RfbEvent eventAttendances(Set<RfbEventAttendance> rfbEventAttendances) {
        this.eventAttendances = rfbEventAttendances;
        return this;
    }

    public RfbEvent addEventAttendance(RfbEventAttendance rfbEventAttendance) {
        this.eventAttendances.add(rfbEventAttendance);
        rfbEventAttendance.setRfbEvent(this);
        return this;
    }

    public RfbEvent removeEventAttendance(RfbEventAttendance rfbEventAttendance) {
        this.eventAttendances.remove(rfbEventAttendance);
        rfbEventAttendance.setRfbEvent(null);
        return this;
    }

    public void setEventAttendances(Set<RfbEventAttendance> rfbEventAttendances) {
        this.eventAttendances = rfbEventAttendances;
    }
