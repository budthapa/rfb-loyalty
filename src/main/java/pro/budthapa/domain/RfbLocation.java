...
public class RfbLocation implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<RfbEvent> events = new HashSet<>();
    ...
    public Set<RfbEvent> getEvents() {
        return events;
    }

    public RfbLocation events(Set<RfbEvent> rfbEvents) {
        this.events = rfbEvents;
        return this;
    }

    public RfbLocation addEvent(RfbEvent rfbEvent) {
        this.events.add(rfbEvent);
        rfbEvent.setRfbLocation(this);
        return this;
    }

    public RfbLocation removeEvent(RfbEvent rfbEvent) {
        this.events.remove(rfbEvent);
        rfbEvent.setRfbLocation(null);
        return this;
    }

    public void setEvents(Set<RfbEvent> rfbEvents) {
        this.events = rfbEvents;
    }
