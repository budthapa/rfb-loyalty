package pro.budthapa.web.rest;

import pro.budthapa.config.Constants;
import pro.budthapa.RfbloyaltyApp;
import pro.budthapa.domain.Authority;
import pro.budthapa.domain.PersistentToken;
import pro.budthapa.domain.User;
import pro.budthapa.repository.AuthorityRepository;
import pro.budthapa.repository.PersistentTokenRepository;
import pro.budthapa.repository.UserRepository;
import pro.budthapa.security.AuthoritiesConstants;
import pro.budthapa.service.MailService;
import pro.budthapa.service.dto.UserDTO;
import pro.budthapa.web.rest.errors.ExceptionTranslator;
import pro.budthapa.web.rest.vm.KeyAndPasswordVM;
import pro.budthapa.web.rest.vm.ManagedUserVM;
